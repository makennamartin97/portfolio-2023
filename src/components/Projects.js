...
import heraimg from '../images/heraimg.png'
import hera from '../images/HERA.mov'
            ...
            <div className="containrow">
                ...
                <Modal show={this.state.show == 'sec'} bodyclassname="custom-modal-style">
                    ...
                    <video id="samp" width="640" height="480" controls>
                        <source src={hera} type="video/mov">
                            </source>
                        </video>
                        <h4>Description:</h4>
                        <p>Platform for businesses to create, customize, and deploy smart contracts on the Ethereum blockchain without the need for coding and hiring developers.</p>
